...
makeCacheMatrix <- function(x = matrix()) {
        ...
        set <- function(y) {
                ...
                f <<- NULL ## re-initialize f in the parent environment to null
        }
        get <- function() x ## return the matrix x
        setinverse <- function(inverse) c <<- inverse ## set the cache f equal to the inverse of the matrix x
        getinverse <- function() f ## return the cached inverse of x
